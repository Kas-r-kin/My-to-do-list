    ...
    echo "<nav class=\"navbar navbar-inverse navbar-fixed-top\" role=\"navigation\">";
        echo "<div class=\"container\">";
            ...
            echo "<div class=\"navbar-header\">";
                ...
                echo "</button>";
					echo "<li>";
                        echo "<a href=\"./Tafaire.php?lang=fr\">Français</a>";
                    echo "</li>";
                    echo "<li>";
                        echo "<a href=\"./Tafaire.php?lang=en\">English</a>";
                    echo "</li>";
    ...
    echo "<div class=\"container\">";
        ...
        echo "<div class=\"row\">";
            echo "<div class=\"col-lg-12\">";
                echo "<h1 class=\"page-header\">$TXT_AFAIRE";
                    echo "<small></small>";
                echo "</h1>";
            echo "</div>";
        echo "</div>";
       ...
       echo "<div class=\"row\">";
            ...
            echo "<p>$TXT_TASK $nom</p>";
                echo "<a href=\"Taffichage.php?Tache=$nom&amp;type=$Type&amp;lang=$lang\">";
                    echo "<img class=\"img-responsive\" src=\"./Images/chacal1.jpg\" alt=\"chacal1 !\">";
                echo "</a>";
            echo "</div>";
        echo "</div>";
        echo "<!-- /.row -->";
